...
class AppTopologyTest {
    ...
    static void setUpAll() {
        ...
        TopologyBuilder.withBuilder(streamsBuilder);
    ...
    void impressionFlowTest() {
        ...
        ProducerRecord<String, CampaignPerfomance> record = topologyTestDriver.readOutput(
                AppConfigs.outputTopic,
                AppSerdes.String().deserializer(),
                AppSerdes.CampaignPerfomance().deserializer());
    ...
    void stateStoreTest() {
        KeyValueStore<String, CampaignPerfomance> store = topologyTestDriver.getKeyValueStore(AppConfigs.stateStoreNameCP);
        CampaignPerfomance cpValue = store.get("ABC Ltd");
