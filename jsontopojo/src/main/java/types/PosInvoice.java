...
public class PosInvoice extends Invoice
{
    ...
    private List<DeliveryAddress> deliveryAddress = new ArrayList<DeliveryAddress>();
    ...
    public PosInvoice withDeliveryType(Double deliveryType) {
        this.deliveryType = deliveryType;
        return this;
    }
    ...
    public PosInvoice withDeliveryAddress(List<DeliveryAddress> deliveryAddress) {
        this.deliveryAddress = deliveryAddress;
        return this;
    }
    ...
    @Override
    public PosInvoice withInvoiceLineItems(List<InvoiceLineItem> invoiceLineItems) {
